...
# Pi-WoL Standard Clean Installer Layer (No Git, No Base64)
COLOR_RED='\033[0;31m'
...
# 🛠️ STREAMING STEP 1: WRITE CORE NETWORK LOGIC DIRECTLY (Single quotes turn off Bash interpretation)
...
run_with_spinner "Initializing database local layout storage profiles" \
    "cd $REAL_HOME/Pi-WoL && echo '{}' > devices.json && chown $REAL_USER:$REAL_USER devices.json"
